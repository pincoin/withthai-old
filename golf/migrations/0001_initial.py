# Generated by Django 3.0.5 on 2020-05-02 13:54
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('green_fee_selling_price', models.DecimalField(decimal_places=2, help_text='THB', max_digits=11, verbose_name='Start from')),
                ('thumbnail1', easy_thumbnails.fields.ThumbnailerImageField(blank=True, null=True, upload_to=golf.models.upload_directory_path, verbose_name='Thumbnail 1')),
                ('thumbnail2', easy_thumbnails.fields.ThumbnailerImageField(blank=True, null=True, upload_to=golf.models.upload_directory_path, verbose_name='Thumbnail 2')),
                ('thumbnail3', easy_thumbnails.fields.ThumbnailerImageField(blank=True, null=True, upload_to=golf.models.upload_directory_path, verbose_name='Thumbnail 3')),
                ('thumbnail4', easy_thumbnails.fields.ThumbnailerImageField(blank=True, null=True, upload_to=golf.models.upload_directory_path, verbose_name='Thumbnail 4')),
                ('thumbnail5', easy_thumbnails.fields.ThumbnailerImageField(blank=True, null=True, upload_to=golf.models.upload_directory_path, verbose_name='Thumbnail 5')),
